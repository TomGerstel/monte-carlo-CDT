...
To simplify matters, we only consider 2-dimensional spacetimes with periodic boundaries. The resulting topology is that of a 2-torus. With this in mind, we make a few useful observations:
\begin{itemize}
